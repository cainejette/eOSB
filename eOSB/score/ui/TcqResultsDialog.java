...
/**
 * The dialog in which users input the results of the {@link Tcq}s.
 * @author cjette
 * 
 */
public class TcqResultsDialog extends StandardDialog {
  ...
  private void init() {
    ...
    TcqResultsTabListener keyListener = new TcqResultsTabListener(this.teamAFieldA,
        this.teamAFieldB, this.teamBFieldA, this.teamBFieldB, this.okButton, this.cancelButton);
...
//  panel.add(note);
  ...
  public ButtonPanel createButtonPanel() {
    ...
    SetTcqResultsAction setTcqResultsAction = new SetTcqResultsAction(this, this.handler,
        this.teamAFieldA, this.teamAFieldB, this.teamBFieldA, this.teamBFieldB);
  ...
  public JComponent createContentPanel() {
    ...
    final JLabel tcqALabel = new JLabel("<HTML><b>" + this.handler.getCurrentRound().getName() + " TCQ A</b></HTML>");
    final JLabel tcqBLabel = new JLabel("<HTML><b>" + this.handler.getCurrentRound().getName() + " TCQ B</b></HTML>");
