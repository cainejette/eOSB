...
/**
 * Displays time/score information to the students.
 * @author cjette
 * 
 */
public class InformationFrame extends JFrame implements EventSubscriber<EventServiceEvent> {
  ...
  /**
   * @param shouldUseScoreboard true if displays the score, false otherwise
   * @param shouldUseTimer true if displays the clock, false otherwise
   */
  public InformationFrame(boolean shouldUseScoreboard, boolean shouldUseTimer) {
    ...
    if (shouldUseScoreboard) {
      ...
      this.add(this.createScorePanel(),
          "growx, align center center");
  ...
  private void display() {
    if (this.shouldDisplay) {
      ...
      this.setTitle("eOSB Round Information");
      this.setIconImage(new ImageIcon(ClassLoader.getSystemClassLoader().getResource(IconFactory.LOGO))
          .getImage());
      this.pack();
